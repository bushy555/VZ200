...
; With MODE (1) graphics equailiser. 4 pixels wide.  Without screen buffer
...
;	call	$28a7		; VZ ROM Print string.
	...
	ld 	hl, 28672	; CLEAR Equaliser SCREEN
...
;	ld 	hl, 28672+160+96+256+512+512	; CLEAR Equaliser SCREEN
;	ld	bc, 255			; to a dark green background
;l02:	ld	(hl), 0
;	inc	hl
;	djnz	l02			; LDIR doesn't work properly for some reason
;
;	ld 	hl, 28672+160+96+512+512+512	; CLEAR Equaliser SCREEN
;	ld	bc, 255			; to a dark green background
;l03:	ld	(hl), 0
;	inc	hl
;	djnz	l03			; LDIR doesn't work properly for some reason
	...
	ld 	hl, 28672+160+12+320+512+512+512		; Do  reg A
	ld	c, a
...
;	srl	a
	inc	a
	ld	b ,a
	ld 	hl, 28672+160+320+512+512+512
l2:	ld	(hl), 170
	inc	hl
	ld	(hl), 170
	inc	hl
...
;	srl	a
	inc	a
	ld	b, a
	ld 	hl, 28672+160+16+320+512+512+512
l3:	ld	(hl), 255 ;c			;159
	inc	hl
	ld	(hl), 255
	inc	hl
...
;	srl	a
	inc	a
	ld	b, a
	ld 	hl, 28672+160+4+320+512+512+512
l4:	ld	(hl), 85;c
	inc	hl
	ld	(hl), 85;c
	inc	hl
...
;	srl	a
	inc	a
	ld	b, a
	ld 	hl, 28672+160+20+320+512+512+512
l42:	ld	(hl), 170;c
	inc	hl
	ld	(hl), 170;c
	inc	hl
...
;	srl	a
	inc	a
	ld	b, a
	ld 	hl, 28672+160+8+320+512+512+512
l5:	ld	(hl), 255 ;c			;159
	inc	hl
	ld	(hl), 255;c
	inc	hl
...
;	srl	a
	inc	a
	ld	b, a
	ld 	hl, 28672+160+24+320+512+512+512
l52:	ld	(hl), 85;c			;159
	inc	hl
	ld	(hl), 85;c
	inc	hl
...
;	srl	a
	inc	a
	ld	b, a
	ld 	hl, 28672+160+28+320+512+512+512
l53:	ld	(hl), 170;c			;159
	inc	hl
	ld	(hl), 170;c
	inc	hl
