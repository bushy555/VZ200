...
;
;
;  MODE(0) Graphical equaliser Routine.
; 	- grabs A, H, D, E
; 	- skips regs L, B, C --- but uses them in routine. 
;
;
;##############################################
...
; NOT USED	; L, B, C
	...
	ld 	hl, 28672+160+96	; CLEAR BITS SCREEN	
	ld	bc, 255
l0:	ld	(hl), 32
	inc	hl
	djnz	l0
	...
	ld 	hl, 28672+160+3+320		; Do  reg A
	ld	c, a
	srl	a
	srl	a
	srl	a
...
MSG1	db "PHASERX 1-BIT PLAYER.  BY UTZ.",00
MSG2	db $0d,"VZ CONVERSION BY BUSHY."
	db " AUG'19.",0
MSG3	db $0d,"SONG: LAST SUMMER.",0
