...
MSG1	db "PYTHA ENGINE. BY UTZ",$0d,$0a	
	db "VZ CONVERSION BY BUSHY AUG 2019.",0
;*******************************************************************************
music_data
;	include "music.asm"
;sequence
...
mdb_Patterns_blk4
	...
	dw $840, $1, f1
	dw $840, $1, g1
	dw $800, $1, ais3, $1, gis1
	dw $800, $1, gis3, $1, ais1
	db $80
