...
quit: 	jp 	$1a19			; Jump to VZ basic
	

m1:	ld 	hl,faseuno_musicData	; song 1
	jr	play1
m2:	ld 	hl,faseduo_musicData	; song 2
	jr	play1
m3:	ld 	hl,fasetre_musicData	; song 3
	jr	play1


;	ld 	hl,musicData
;	ld 	hl,faseuno_musicData	; song 1
;	ld 	hl,faseduo_musicData	; song 2
;	ld 	hl,fasetre_musicData	; song 3
...
MSG1	db "PHASER 1 ENGINE, BY UTZ",$0d,$0d,0
MSG2	db "1. FASE UNO.",$0d,0
MSG3	db "2. FASE DUO.",$0d,0
MSG4	db "3. FASE TRES.",$0d,$0d,0
MSG5	db "Q. QUIT.",$0d,0
