...
loop1:	
	ld	hl, nyan_pic	; 		; vid buffer 1 $B000
	ld	de, buffer7	;buffer2	; vid buffer 2 $C000 

	call	decompress		; decompress rountine

	ld	hl, astro_pic	; 		; vid buffer 1 $B000
	ld	de, buffer8	;buffer2	; vid buffer 2 $C000 
...
db $000,$019,$003,$001,$033,$001,$008,$001,$000,$014
 ; ---------------------------------------------------------
