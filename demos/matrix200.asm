...
; ==============
;
;	random63_1	A = RND (0 - 63)
;	random63_2	A = RND (0 - 63) + 64
;
...
;	call 	random		; select 0-255 number of times to display random chars.
	...
	ld	b,  55
loop1b:	call	random63_2		; select random char to display.
	ld	de, (a1)
	ld	(de), a	
	djnz	loop1b
	
	ld	b, 55
loop2b:	call	random63_2
	ld	de, (a2)
	ld	(de), a	
	djnz	loop2b

	ld	b, 85
loop3b:	call	random63_2
	ld	de, (a3)
	ld	(de), a	
	djnz	loop3b

	ld	b, 120
loop4b:	call	random63_2
	ld	de, (a4)
	ld	(de), a	
	djnz	loop4b

	ld	b, 50
loop5b:	call	random63_2
	ld	de, (a5)
	ld	(de), a	
	djnz	loop5b

	ld	b, 5
loop6b:	call	random63_2
	ld	de, (a6)
	ld	(de), a	
	djnz	loop6b
...
;- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
loop15:	call	random		; POSITION = 28672 + rnd( 0-255 ) 
	ld	b, 0
	ld	c, a
	ld	hl, 28672
	add	hl, bc
