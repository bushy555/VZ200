; ASTRO , NYAN CAT and DSE de-compression RLE routine.
;
;
; To create compression routine:
;    Get PSP RAW image. (nyan1.raw)
;    STEPL NYAN1.RAW NYAN1.OUT     Option (A)    - Does nibbling into hex and outputs to binary image.
;    COMPRESS NYAN1.OUT NYAN1.RLE 		 - Does RLE compression and outputs to compressed .RLE binary image.
;    STEPL NYAN1.RLE NYAN1.INC	   Option (9)	 - Converts .RLE compressed binary image into an ASCII include file.
;    Load ascii include file, and add to this RLE decompression program.
;    Assemble and run.
;
;	
; Reads in from PIC1 into BUFFER1 (ASCII compressed RLE version of RAW screenshot)
; Decompresses and writes into BUFFER2
; Dumps BUFFER2 into $7000 video.
; Loop to Next PIC
;
;
...
loop1:	ld	hl, nyan_pic		; Put nyan into Buffer 1
	...
	ld	hl, dse_pic		; put astro into Buffer 1
	ld	de, buffer1
	ld	bc, 2048
	ldir
	call	decompress		; decompress rountine
...
here:	push	hl
	...
	push	iy
	pop	de
	ld	hl, 2048	; CMP DE, HL which sits in ROM.   "CMP DE, 2048" for screen size counter.
	rst	$18		; go do it.
	jp	c, quit		; Set carry true if DE>HL
	pop	iy
	pop	de
	pop	hl
	jr	l0b
...
quit:	pop	iy
	...
	call	0060H		; delay in ROM. BC is kept so do it again for double time delay.
...
db $000,$019,$003,$001,$033,$001,$008,$001,$000,$01A
 ; ---------------------------------------------------------

dse_pic:  ; 128x64 COMPRESSED
db $000,$003,$055,$002,$040,$001,$000,$01C,$015,$001,$045,$001,$015,$001,$054,$001
db $000,$01B,$005,$001,$055,$004,$000,$01B,$010,$001,$045,$001,$055,$003,$050,$001
db $000,$019,$001,$001,$055,$003,$054,$001,$011,$001,$055,$001,$000,$019,$004,$001
db $055,$002,$000,$002,$010,$001,$055,$001,$040,$001,$000,$018,$005,$001,$055,$001
db $050,$001,$000,$002,$004,$001,$055,$001,$050,$001,$000,$018,$005,$001,$054,$001
db $040,$001,$000,$002,$001,$001,$055,$001,$050,$001,$000,$018,$015,$001,$055,$001
db $000,$003,$005,$001,$055,$001,$054,$001,$000,$018,$015,$001,$054,$001,$000,$003
db $005,$001,$055,$001,$054,$001,$000,$018,$015,$001,$050,$001,$000,$002,$005,$001
db $055,$003,$000,$018,$055,$001,$040,$001,$000,$001,$001,$001,$055,$003,$051,$001
db $000,$018,$055,$001,$041,$001,$040,$001,$054,$001,$000,$001,$040,$001,$055,$001
db $051,$001,$000,$018,$051,$001,$055,$001,$051,$001,$055,$002,$040,$001,$015,$001
db $001,$001,$000,$018,$015,$001,$005,$001,$055,$002,$000,$001,$010,$001,$005,$001
db $050,$001,$000,$018,$015,$001,$055,$001,$050,$001,$044,$001,$000,$001,$040,$001
db $004,$001,$010,$001,$000,$018,$005,$001,$055,$001,$050,$001,$005,$001,$055,$001
db $000,$002,$011,$001,$000,$018,$005,$001,$000,$001,$050,$001,$000,$004,$001,$001
db $000,$018,$001,$001,$055,$001,$040,$001,$000,$003,$001,$002,$000,$019,$040,$001
db $015,$001,$045,$001,$005,$001,$040,$001,$001,$001,$054,$001,$000,$019,$040,$001
db $045,$001,$054,$001,$001,$001,$040,$001,$015,$001,$000,$01A,$015,$001,$040,$001
db $000,$001,$005,$001,$040,$001,$054,$001,$000,$01A,$015,$001,$040,$001,$015,$001
db $054,$001,$005,$001,$054,$001,$000,$01A,$005,$002,$001,$001,$000,$001,$015,$001
db $050,$001,$000,$01A,$005,$001,$000,$003,$001,$001,$050,$001,$000,$01A,$001,$001
db $040,$001,$055,$001,$040,$001,$005,$001,$000,$01C,$040,$001,$000,$002,$015,$001
db $000,$01C,$014,$001,$000,$001,$001,$001,$050,$001,$000,$01C,$001,$001,$050,$001
db $015,$001,$000,$01E,$005,$001,$040,$001,$000,$0ff,$000,$0ff,$000,$0ff,$000,$0ff
 ; ---------------------------------------------------------
