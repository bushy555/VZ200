...
+ Needs sounds - I dont have a sound blaster compatible sound card.
   (so I cant tell what it sounds like)
+ Code is a mess, that is "Daves Engineering" at work.
   (C is my third language, so please be excusing my grammer) 
