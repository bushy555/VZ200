...
#if defined(__PC6001__)	|| defined(__MC1000__) || defined(__EINSTEIN80COLUMNS__) // NEC PC-6001, CCE MC-1000 or Tatung Einstein 80 column mode
	#include <sys/ioctl.h>
#endif
...
// So far, these are all consoles with two joysticks 
#if defined(__PV1000__) || defined(__COLECO__)	// Casio PV-1000 or ColecoVision
...
#elif defined(__COLECO__) // ColecoVision
	#define JOYSTICK_1 1
	#define JOYSTICK_2 2
...
#if defined(__ABC80__) || defined(__ACE__) || defined(__AQUARIUS__) || defined(__NASCOM__) || defined(__P2000__) || defined(__VG5000__) || defined(__SHARPMZ__) || defined(__VZ200__) || defined(__Z1013__) || defined(__Z9001__) || defined(__PC6001__) || defined(__MSX__) || defined(__CPC__)
	#include <conio.h>
	#define USE_ANSI 1
#elif ((defined(__TRS80__) && !defined(__EG2000__)) || defined(__PV1000__)) || defined(__SORCERER__) || defined(__COLECO__) || defined(__ALPHATRO__) || defined(__SPC1000__) || defined(__MULTI8__) || defined(__RX78__) || defined(__PV2000__) || defined(__SPECTRUM__) || defined(__KC__) || defined(__SVI__) || defined(__MTX__) || defined(__M5__) || defined(__SC3000__) || defined(__LASER500__) || defined(__EINSTEIN__) || (defined(__LYNX__) && !defined(__LYNXSTANDARDCONSOLE__)) || defined(__MC1000__) || defined(__BEE__) // TRS-80, Casio PV-1000, Exidy Sorcerer, ColecoVision, ...
...
#if defined(__ALPHATRO__) || defined(__SPC1000__) || defined(__MULTI8__) || defined(__TRS80__) || defined(__SORCERER__) || defined(__RX78__) || defined(__PV2000__) || defined(__SPECTRUM__) || defined(__SVI__)|| defined(__MTX__) || defined(__M5__) || defined(__SC3000__) || defined(__LASER500__) || defined(__EINSTEIN__) || defined(__OSBORNE1__) || defined(__LYNX__) || defined(__MC1000__) || defined(__BEE__)
	#define USE_NATIVE_INPUT 1		// kbhit() and getch() without conio.h
#endif

#if defined(__ZX81__) || defined(__ZX80__) || defined(__ACE__) || defined(__VZ200__) || defined(__SORCERER__) || defined(__VG5000__) || defined(__TRS80__) || defined(__AQUARIUS__) || defined(__SPECTRUM__)
...
#if (defined(__VZ200__) && !defined(VZ200_LGFX)) || defined(__P2000__) || (defined(__TRS80__) && defined(__EG2000__))
...
#if (defined(__VZ200__) && !defined(VZ200_LGFX)) || (defined(__TRS80__) && defined(__EG2000__))
  #define FOUR_BY_SIX_CHARACTERS_WIDE_SCREEN 1
#endif
// On some 4x6 systems we don't need to show the menu texts in two parts
#if defined(__TRS80__) && defined(__EG2000__)
...
#if (defined(__TRS80__) && !defined(__EG2000__)) || defined(__SORCERER__) || defined(__MULTI8__) || defined(__OSBORNE1__) || defined(__CPC__) || defined(__BEE__) || defined(__EINSTEIN80COLUMNS__) // TRS-80, Exidy Sorcerer, Mitsubishi Multi8, Osborne 1, CPC, Tatung Einstein 80 Columns, Microbee
...
#if defined(__COLECO__) || defined(__MULTI8__) || defined(__RX78__) || defined(__PV2000__) || defined(__SPECTRUM__) || defined(__SC3000__) || defined(__KC__) || defined(__MSX__) || defined(__M5__) || defined(__SVI__) || defined(__MTX__) || (defined(__EINSTEIN__) && !defined(__EINSTEIN80COLUMNS__)) || defined(__CPC__) || defined(__MC1000__)
  #define USE_C_PLOT 1
#endif 
...
// Note: the screen dimensions can be determined on runtime by calling getmaxx() and getmaxy()
#if defined(__ZX81__) || defined(__ZX80__) || defined(__ACE__) || defined(__GAL__) || defined(__COLECO__) || defined(__PV2000__) || defined(__SC3000__) || defined(__PC6001__) || defined(__MSX__) || defined(__M5__) || defined(__SVI__) || defined(__MTX__) || defined(__SPC1000__) || (defined(__EINSTEIN__) && !defined(__EINSTEIN80COLUMNS__)) || defined(__MC1000__) // ZX81, ZX80, Jupiter Ace, Galaksija, ColecoVision, Casio PV-2000 (using c_plot), etc.
	#define X_RES 64
	#define Y_RES 48
	#define X_COLS 32
	...
	#define STARTUP_Y 39
#elif defined(__AQUARIUS__) || defined(__Z9001__) || defined(__LASER500__)	// Mattel Aquarius, Robotron Z9001, Laser 500/700
	#define X_RES 80
	#define Y_RES 48
	#define X_COLS 40
	#define STARTUP_P1_X 12
	...
	#define STARTUP_Y 54
#elif defined(__Z1013__) || defined(__LYNX__)	// Robotron Z1013 or Camputers Lynx
	#define X_RES 64
	#define Y_RES 64
	#define X_COLS 32
	#define STARTUP_P1_X 10
...
// Delay Values
// These values are real milliseconds
// We adjust the speed so that in 1-player mode it takes the player 
// about 5,5 seconds to horizontally cross the entire screen.
// On the higher-resolution systems (VZ200, EG2000), we set the values so that 
// this takes about 7,5 seconds.
...
// Text constants
	...
	#define MENU_LINE2 "by RobertK (2016, 2018)\n"
		...
		#if defined(__PC6001__)	|| (defined(__VZ200__) && defined(VZ200_LGFX)) // NEC PC-6001 or lo-res VZ200
...
uint myKeyPressed(uint scancode)
{
		...
		// only for the Sinclair computers, the Jupiter Ace and the VZ200. 
		// Provisionally we use ANSI key input for all other systems, although 
		// this is problematic in two-player mode as it does 
		// not allow two keys to be pressed simultaneously
		return 0;
	#endif
}
...
{
  #if defined(__MC1000__)	// CCE MC-1000
	int mode=0;
...
void main()
{
  ...
  #if (defined(__VZ200__) && !defined(VZ200_LGFX)) || defined(__ABC80__) || defined(__P2000__) || defined(__Z9001__) || defined(__MULTI8__) || defined(__MSX__) || defined(__SVI__)
