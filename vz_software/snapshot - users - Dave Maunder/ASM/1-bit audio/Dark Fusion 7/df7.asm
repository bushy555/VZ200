...
DRMSNR1	LD	A,16
	...
	JR	NZ,DRMSNR2
	RES	4,A
DRMSNR2	OUT	(#FE),A		; sound of snare drum
	RLC	(IX+0)
	DJNZ	DRMSNR1
...
L_8C18	LD	A,#10
	...
	JR	NZ,L_8C22
	RES	4,A
L_8C22	OUT	(#FE),A		; sound of bass drum
	RLC	(IX+#00)
	DB	#00
	DJNZ	L_8C18
	INC	IX
