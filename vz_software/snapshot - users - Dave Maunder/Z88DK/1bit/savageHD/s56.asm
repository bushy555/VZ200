...
; =====================================================================================================================
;
;  this version of the core is the most true to the original sound
;
;  (*) discretization frequency:	3500000/128 ~ 27.3kHz
;  (*) relative channel durations:	72 / 56
;  (*) relative channel volumes:	1:56/72	= 1:0.778
;
; =====================================================================================================================

		defb	$FE		; CP n (it is like "jr PreMainLoop", only faster and takes less space ;)

PrePreMainLoop:	ex	de, hl		; 4t
		nop
...
;  (6) -> (7)		->	4+4+(11+4+8 + 11+4+8+10) + 11 = 75t / 56t	(output changes)
;  (6) -> (8)		->	4+4+(11+4+13 + 4+4+12 + 4+4) + 11 = 75t / 56t	(output stays the same)
;  (6) -> (8) -> (9)	->	4+4+11+4+13 + 4+4+7 + 4+6+4+10 = 75t		(special fx for channel 2)
;
...
ContChannel2:	rlca			; 4t			(8)
		rrca			; 4t
		jr	nc, PrePreMainLoop ; 12t/7t
